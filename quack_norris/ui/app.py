...
from quack_norris.ui.subprocess_helpers import startup_servers_in_background
from quack_norris.config import Config


def create_ui(config: Config):
    logger.info("Starting UI")
    startup_servers_in_background(dev=config.get("debug", False))
    ...
    launcher.show()
    web_view_window = WebViewWindow(config, launcher)
